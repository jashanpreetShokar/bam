...
// altered version on 2020-02-29
// changed:
// Sprite to RectangleShape at PixelPerfectTest
#ifndef COLLISION_H
#define COLLISION_H
...
namespace Collision {
	...
	//////
	bool PixelPerfectTest(const sf::RectangleShape& Object1, const sf::RectangleShape& Object2, sf::Uint8 AlphaLimit = 0);
